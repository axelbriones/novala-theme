...
<div class="mb-4">
    ...
    if ($cert_logo) : ?>
    <img src="<?php echo esc_url($cert_logo); ?>" alt="Certification" class="h-20 w-auto opacity-90 hover:opacity-100 transition-opacity">
    <?php endif; ?>
</div>
<div class="flex gap-4">
<?php if ($fb = novara_get_option('social_facebook')): ?>
<a class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center hover:opacity-80 transition-opacity" href="<?php echo esc_url($fb); ?>" target="_blank">
<span class="material-symbols-outlined text-sm">public</span>
</a>
<?php endif; ?>
<?php if ($ig = novara_get_option('social_instagram')): ?>
<a class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center hover:opacity-80 transition-opacity" href="<?php echo esc_url($ig); ?>" target="_blank">
<span class="material-symbols-outlined text-sm">camera_alt</span>
</a>
<?php endif; ?>
<?php if ($tw = novara_get_option('social_twitter')): ?>
<a class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center hover:opacity-80 transition-opacity" href="<?php echo esc_url($tw); ?>" target="_blank">
<span class="material-symbols-outlined text-sm">flutter_dash</span>
</a>
<?php endif; ?>
<?php if ($tt = novara_get_option('social_tiktok')): ?>
<a class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center hover:opacity-80 transition-opacity" href="<?php echo esc_url($tt); ?>" target="_blank">
...
<a class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center hover:opacity-80 transition-opacity" href="mailto:<?php echo antispambot($em); ?>">
